...
export const loadFont = (fontPath) => {
  ...
  return fetch(`${fontPath}/font-list.json`)
    .then((res) => {
      if (res.ok) {
        return res.json();
      } else {
...
// convert numerals to full width chars
...
export const inheritProp = (obj, parentObj = {}) => {
  ...
  inheritPropList.forEach((inherit) => {
    if (
      !Object.prototype.hasOwnProperty.call(obj, inherit) &&
      Object.prototype.hasOwnProperty.call(parentObj, inherit)
    ) {
